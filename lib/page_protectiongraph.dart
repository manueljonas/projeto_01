...
class ProtectionGraphPage extends StatefulWidget {
  const ProtectionGraphPage({
    super.key,
    required this.title,
  });
  ...
  @override
  ProtectionGraphPageState createState() => ProtectionGraphPageState();
}

class ProtectionGraphPageState extends State<ProtectionGraphPage> {
